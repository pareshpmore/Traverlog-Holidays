...
// /* ---------- Small decorative gopuram-style arch used on card tops ---------- */
...
// /* Renders a real photo when `src` is set, otherwise the placeholder
//    gradient block with its label — used by both the card cover and slider. */
...
//     <button
//       onClick={() => onOpen(tour)}
//       className="group relative text-left rounded-2xl overflow-hidden bg-[#FBF7EE] border border-[#241512]/10 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#9B2C2C] focus-visible:ring-offset-2 focus-visible:ring-offset-[#EDE6D6]"
//     >
//       <div className="relative h-44 w-full overflow-hidden">
//         <TourImage image={cover} />
//         <ArchAccent className="absolute -bottom-px left-0 w-full h-8 text-[#FBF7EE]" />
//         <span className="absolute top-3 right-3 flex items-center gap-1 rounded-full bg-black/30 backdrop-blur px-3 py-1 text-[11px] tracking-wide uppercase text-[#F7EFD8]">
...
//       <div className="p-5">
//         <div className="flex items-center gap-1.5 text-[#9B2C2C] text-[11px] font-semibold tracking-[0.14em] uppercase mb-2">
//           <MapPin size={13} strokeWidth={2.5} />
//           {tour.region}
//         </div>
//         <h3
//           className="text-[#241512] text-xl leading-snug mb-1.5"
//           style={{ fontFamily: "'Yatra One', cursive" }}
//         >
//           {tour.title}
//         </h3>
//         <p className="text-blue-700/80 text-sm leading-relaxed">{tour.tagline}</p>
...
//         <span
//           className="block p-5 text-[#F7EFD8] text-lg sm:text-xl"
//           style={{ fontFamily: "'Yatra One', cursive" }}
//         >
//           {current.label}
//         </span>
...
//     >
//       <div
//         className="absolute inset-0 bg-[#241512]/70 backdrop-blur-sm"
//         onClick={onClose}
//       />

//       <div className="relative w-full max-w-2xl max-h-[88vh] overflow-y-auto rounded-2xl bg-[#FBF7EE] shadow-2xl">
//         <button
//           onClick={onClose}
//           aria-label="Close"
...
//           <div className="flex items-center gap-1.5 text-blue-700 text-[11px] font-semibold tracking-[0.14em] uppercase mb-2">
//             <MapPin size={13} strokeWidth={2.5} />
//             {tour.region} · {tour.duration}
//           </div>
//           <h2
//             className="text-[#7a2321] text-2xl sm:text-3xl leading-tight mb-2"
//             style={{ fontFamily: "'Yatra One', cursive" }}
//           >
//             {tour.title}
//           </h2>
//           <p className="text-[#241512]/70 text-sm sm:text-base mb-8">{tour.tagline}</p>

//           {/* pilgrimage-path itinerary timeline */}
...
//                   <span className="absolute -left-9 top-0 grid place-items-center h-7 w-7 rounded-full bg-[#9B2C2C] text-[#F7EFD8] text-xs font-bold ring-4 ring-[#FBF7EE]">
//                     {d.day}
//                   </span>
//                   <h3 className="text-blue-900 font-semibold text-base sm:text-lg mb-1">
//                     Day {d.day}: {d.title}
//                   </h3>
//                   <p className="text-blue-700/80 text-sm leading-relaxed mb-2">{d.body}</p>
//                   {d.highlights.length > 0 && (
//                     <ul className="space-y-4">
//                       {d.highlights.map((h, i) => {
//                         // A highlight can be a plain string (no photo) or
//                         // { text, img } (with a full photo shown above it).
...
//                                   src={img}
//                                   alt={text}
//                                   className="w-full max-w-sm h-44 object-contain bg-[#241512]/5 rounded-lg border border-[#241512]/10"
//                                 />
//                               </div>
//                             )}
...
//                                 </span>
//                               )}
//                               <span className="text-blue-700/80 text-sm leading-relaxed">
//                                 {text}
//                               </span>
//                             </div>
//                           </li>
...
//           <button
//             onClick={onClose}
//             className="mt-8 w-full sm:w-auto rounded-full bg-[#9B2C2C] hover:bg-[#7a2321] transition-colors text-[#F7EFD8] text-sm font-semibold px-6 py-3"
//           >
...
//   return (
//     <div className="min-h-screen bg-[#EDE6D6] px-5 sm:px-10 py-14">
//       <style>{`
...
//           <div className="inline-flex items-center gap-1.5 text-[#9B2C2C] text-xs font-semibold tracking-[0.2em] uppercase mb-3">
//             <Sparkles size={14} />
//             Maharashtra Pilgrimage Tours
//           </div>
//           <h1
//             className="text-[#7a2321] text-4xl sm:text-5xl leading-tight"
//             style={{ fontFamily: "'Yatra One', cursive" }}
//           >
//             Sacred journeys across Maharashtra
//           </h1>
//           <p className="text-[#241512]/60 mt-3 max-w-xl mx-auto text-sm sm:text-base">
      ...
      <div className="relative w-full max-w-2xl max-h-[88vh] overflow-y-auto rounded-2xl bg-[#FBF7EE] shadow-2xl">
        ...
        <div className="p-6 sm:p-8">
          ...
          {/* ---------------------------------------------------------------
              ...
              --------------------------------------------------------------- */}
          <div className="mt-10 pt-8 border-t border-[#241512]/10 grid sm:grid-cols-2 gap-5">
            {/* Left column */}
            <div className="rounded-xl bg-[#241512]/[0.03] border border-[#241512]/10 p-5 sm:p-6">
              ...
              {hasLongDescription && (
                <button
                  ...
                  className="mt-1.5 text-xs font-semibold text-[#9B2C2C] hover:underline focus:outline-none"
                >
              ...
              <div className="grid grid-cols-2 gap-4 mt-5">
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-[#9B2C2C] mb-2">
                    Inclusions
                  </p>
                  <ul className="space-y-1.5">
                    {(tour.inclusions || DEFAULT_INCLUSIONS).map((item, i) => (
                      <li
                        key={i}
                        className="flex items-start gap-1.5 text-xs text-[#241512]/75 leading-snug"
                      >
              ...
              <div className="flex items-baseline gap-2 mt-5 pt-4 border-t border-[#241512]/10">
                <span className="text-[10px] font-semibold uppercase tracking-[0.12em] text-[#9B2C2C]">
                  Cost
                </span>
                <span className="text-lg font-bold text-[#7a2321]">
                  {tour.cost || "On request"}
                </span>
                {tour.costNote && (
                  <span className="text-xs text-[#241512]/50">{tour.costNote}</span>
                )}
              </div>
            </div>

            {/* Right column */}
            <div className="rounded-xl bg-gradient-to-br from-[#9B2C2C] to-[#7a2321] p-5 sm:p-6 flex flex-col justify-between">
              <div>
                <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#F7EFD8]/70 mb-2">
                  Inquiry
                </p>
                <h4
                  className="text-[#F7EFD8] text-lg leading-snug mb-2"
                  style={{ fontFamily: "'Yatra One', cursive" }}
                >
                  Inquiry about {tour.title}
                </h4>
                <p className="text-[#F7EFD8]/75 text-sm leading-relaxed">
                  Share your travel dates and group size — we'll send a tailored quote and answer any questions.
                </p>
              </div>
              <button
                onClick={onClose}
                className="mt-6 w-full rounded-full bg-[#F7EFD8] hover:bg-white transition-colors text-[#7a2321] text-sm font-semibold px-6 py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#F7EFD8] focus-visible:ring-offset-2 focus-visible:ring-offset-[#7a2321]"
              >
                Send Inquiry
              </button>
            </div>
